...
**Have:** 3.0.21.1 3.0.4.1 3.1.3.1 3.2.4.1 3.4.3.1 3.5.42.1 3.5.6.1 3.6.42.1 3.8.5.1 3.9.22.1 4.1.2.1 4.2.0.1 4.2.2.1 7.0.26.1* 8.0.3.1* 8.1.1.1*  
<small>*Versions were installed by the newer online installers which automatically patch the game further with all the currently available patches.</small>  
...
**Xunxian (mobile game)** (mostly the same game but for mobile, uses different encrypted asset packing format `.pkg` (`PPkg1.0` / `50 50 6B 67 31 2E 30 00`), not cracked):  
18.5.0 20.2.0 21.2.0 24.1.0 25.1.0 26.2.0 27.3.0

**Blade & Sword 2 (刀剑2)** (uses different encrypted asset packing format `.spk` (`spkm1.0` / `73 70 6B 6D 31 2E 30 00`), not cracked):  
4.6.0.001_0? and 45 ManualPatch files [still available](https://d2.qq.com/down.shtml) for download.
